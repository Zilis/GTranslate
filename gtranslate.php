...
function RefreshDoWidgetCode() {
    ...
    if(translation_method == 'on_fly' || translation_method == 'redirect' || translation_method == 'onfly') {
        ...
        if(widget_look == 'popup') {
            ...
            widget_preview += '<div id="gt_clicked"><span onclick="closeGTPopup()" style="position:absolute;right:2px;top:2px;font-weight:bold;font-size:12px;cursor:pointer;color:#444;font-family:cursive;">X</span></div>'+new_line;
